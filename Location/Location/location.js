let vm = new Vue({
    ...
    data: {
        locations: [{
                ...
                'name': 'habitant',
                'boolean': 'Inactive',
                'address_line_1': "Nunc in purus ut nunc dignissim",
                'address_line_2': "nteger eu tincidunt diam",
                'address_line_3': "Curabitur congue laoreet dapibus",
                'postal_code': 42310,
                'country': "Canada",
                'state': "Alberta",
                'latitude': 223421.1246731098125121,
                ...
                'name': 'Quisque',
                'boolean': 'Inactive',
                'address_line_1': "Interdum et malesuada fames",
                'address_line_2': "Nunc consequat orci ut nunc molestie",
                'address_line_3': "quis viverra lectus ornare",
                'postal_code': 89012,
                'country': "Chile",
                'state': "Coquimbo",
                'latitude': 223421.1246731098125121,
                ...
                'name': 'Vestibulum',
                'boolean': 'Active',
                'address_line_1': "faucibus sapien posuere non",
                'address_line_2': "aecenas nulla massa",
                'address_line_3': "euismod tristique ornare in",
                'postal_code': 88012,
                'country': "Denmark",
                ...
                'name': 'Faucibus',
                'boolean': 'Active',
                'address_line_1': "Suspendisse quis sem at elit vehicula",
                'address_line_2': "Sed consequat ultrices efficitur",
                'address_line_3': "Etiam lacinia feugiat dolor",
                'postal_code': 75622,
                'country': "Finland",
                'state': "Eastern Finland Province",
                'latitude': 223421.1246731098125121,
                'longitude': 223421.1246731098125121,
            }, {
                's_no': 10,
        ...
        detail_information: {},
        // others
        is_additional_options_allowed: false,
        is_loading: false,
        // errors
        create_errors: "",
        edit_errors: "",
    ...
    mounted: function() {
        for (let key = 21; key <= 10000; key++) {
            let tmp = {
                's_no': key,
                'name': this.locations[0]['name'],
                'boolean': this.locations[0]['boolean'],
                'address_line_1': this.locations[0]['address_line_1'],
                'address_line_2': this.locations[0]['address_line_2'],
                'address_line_3': this.locations[0]['address_line_3'],
                'postal_code': this.locations[0]['postal_code'],
                'country': this.locations[0]['country'],
